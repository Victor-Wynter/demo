...
function drawGalboss(ctx, x, y, size) { 
		...
		cherryImage.src = 'img/pote.png'; // Substitua com o caminho da sua imagem
...
function drawMelon(ctx, x, y, size) { 
		// Crie um objeto de imagem
		const cherryImage = new Image();
		cherryImage.src = 'img/pilula.png'; // Substitua com o caminho da sua imagem
...
function drawApple(ctx, x, y, size) { 
		// Crie um objeto de imagem
		const cherryImage = new Image();
		cherryImage.src = 'img/d3.png'; // Substitua com o caminho da sua imagem
